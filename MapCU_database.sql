...
(ARRAY[3,4], 'Take a left and continue straight in the ECCE building, then, take a right to arrive at your destination'),
...
(ARRAY[4,8], '4 to 7'),
(ARRAY[4,9], '4 to 7'),
(ARRAY[5,1], 'Exit the ECAE which is in the East direction, then, continue straight, passing the elavators until you have arrived at the ECCR section'),
(ARRAY[5,2], 'Exit the ECAE which is in the East direction, then, continue straight until you have arrived at the elevators, after that, take a left and continue straight until you have reached the ECCE building then, take a left to arrive at your destination'),
(ARRAY[5,3], 'Exit the ECAE which is in the East direction, then, continue straight until you have arrived at the elevators, after that, take a left and continue straight until you have reached the ECCE building then, take a left to arrive at your destination, finally, continue straight for 1 meter'),
(ARRAY[5,4], 'Exit the ECAE which is in the East direction, then, continue straight until you have arrived at the elevators, after that, take a left and continue straight until you have reached the ECCE building then, take a left to arrive at your destination, afterwards, continue straight for 1 meter, then take a left to arrive at your destination'),
(ARRAY[5,6], 'View left and continue straight to arrive at your destination'),
(ARRAY[5,7], '5 to 7'),
(ARRAY[5,8], '5 to 7'),
(ARRAY[5,9], '5 to 7'),
(ARRAY[6,1], 'Exit the ECAE section which is in the West direction then, continue straight, passing the elavators until you have arrived at the ECCR section'),
(ARRAY[6,2], 'Exit the ECAE section which is in the West direction then, continue straight until you have arrived at the elevators, after that, take a left and continue straight until you have reached the ECCE building then, take a left to arrive at your destination'),
(ARRAY[6,3], 'Exit the ECAE section which is in the West direction then, continue straight until you have arrived at the elevators, after that, take a left and continue straight until you have reached the ECCE building then, take a left to arrive at your destination, finally, continue straight for 1 meter'),
(ARRAY[6,4], 'Exit the ECAE section which is in the West direction then, continue straight until you have arrived at the elevators, after that, take a left and continue straight until you have reached the ECCE building then, take a left to arrive at your destination, afterwards, continue straight for 1 meter, then take a left to arrive at your destination'),
(ARRAY[6,5], 'View East and continue straight to arrive at your destination');
(ARRAY[6,7], '6 to 7'),
(ARRAY[6,8], '6 to 7'),
(ARRAY[6,9], '6 to 7'),
(ARRAY[7,1], '7 to 1'),
